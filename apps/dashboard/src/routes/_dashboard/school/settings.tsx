  ...
  useEffect(() => {
    if (settingsData) {
      setParsedSettings({
        ...
        whatsappEnabled: settingsData.whatsappEnabled ?? DEFAULT_SETTINGS.whatsappEnabled,
        whatsappNumber: settingsData.whatsappNumber || DEFAULT_SETTINGS.whatsappNumber,
        whatsappMessage: settingsData.whatsappMessage || DEFAULT_SETTINGS.whatsappMessage
      })
    }
  }, [settingsData])
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-t pt-6">
                ...
                <div className="flex items-center justify-between mb-4 p-4 bg-muted/50 rounded-lg">
                  ...
                  <Switch
                    id="whatsappEnabled"
                    checked={parsedSettings.whatsappEnabled ?? false}
                    onCheckedChange={(checked) => updateSetting('whatsappEnabled', checked)}
                  />
                </div>

                <div className={`space-y-4 ${!parsedSettings.whatsappEnabled ? 'opacity-50 pointer-events-none' : ''}`}>
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        id="whatsappNumber"
                        type="tel"
                        value={parsedSettings.whatsappNumber}
                    ...
                    <p className="text-xs text-muted-foreground">
                      Country code +256 is added automatically. Leave empty to use phone number above.
                    </p>
                  </div>

                  <div className="p-3 bg-muted/30 rounded-lg border">
                    <p className="text-xs text-muted-foreground mb-1">Auto-generated message preview:</p>
                    <p className="text-sm italic text-muted-foreground">
                      "Hello, I'd like to know more about {parsedSettings.schoolName || 'your school'}."
                    </p>
                  </div>
                </div>
              </div>
