      ...
      <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="p-6 space-y-4">
          ...
          <div id="phone-section" class="hidden">
            <div class="bg-[#25D366]/5 dark:bg-[#25D366]/10 border border-[#25D366]/20 rounded-xl p-4 space-y-3">
              <div class="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-5 h-5 text-[#25D366]">
                ...
                <label class="block text-sm font-semibold text-slate-700 dark:text-slate-200">
                  Your phone <span class="font-normal text-slate-500">(optional but helpful)</span>
                </label>
              </div>
              ...
              <input 
                ...
                class="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-[#25D366] focus:border-transparent outline-none"
              />
            </div>
          </div>
