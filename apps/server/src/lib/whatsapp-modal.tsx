  ...
  return html`
            ...
            <div class="grid grid-cols-2 gap-3" id="inquiry-types">
              ${inquiryTypes.map(type => html`
                <button 
                  ...
                  class="inquiry-btn p-4 rounded-xl border-2 border-slate-200 dark:border-slate-700 hover:border-[#25D366] hover:bg-[#25D366]/5 transition-all text-center group"
                  data-type="${type.id}"
                >
    ...
    <script>
      ...
      async function startWhatsAppChat() {
        ...
        const schoolName = document.getElementById('whatsapp-school-name').value;
